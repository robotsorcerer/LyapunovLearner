...
from visualization.action_panel import Action, ActionPanel
from visualization.textbox import Textbox
from visualization.image_visualizer import ImageVisualizer
from visualization.realtime_plotter import RealtimePlotter
from visualization.traj_plotter import TrajPlotter
from visualization.mean_plotter import MeanPlotter
from visualization.plotter_3d import Plotter3D
...
realtime_plotter = RealtimePlotter(fig, gs[3],
        ...
        alphas=[0.15, 0.15, 0.15, 0.15, 1.0], time_window=100)
